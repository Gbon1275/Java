...
public class GuiDemo extends JFrame{
	...
	public GuiDemo() {
		...
		drawPanel.setBackgroundImage(Util.getImageResource("resources/images/Scotland.jpeg"));
		...
		menuBar.add( iconSupport.iconMenu());
		setJMenuBar(menuBar);
	...
	private JToolBar makeBackgroundToolbar(boolean horizontal) {
		JToolBar backgrounds = new JToolBar( horizontal? JToolBar.HORIZONTAL : JToolBar.VERTICAL);
		newPictureAction.putValue("ShortDescription", "Clear picture");
		backgrounds.add(newPictureAction);
		saveImageAction.putValue("ShortDescription", "Save picture to file");
		backgrounds.add(saveImageAction);
		backgrounds.addSeparator();
		backgrounds.add(new ChooseBackgroundAction("Mandelbrot"));
		backgrounds.add(new ChooseBackgroundAction("Earthrise"));
		backgrounds.add(new ChooseBackgroundAction("Sunset"));
		backgrounds.add(new ChooseBackgroundAction("Cloud"));
		backgrounds.add(new ChooseBackgroundAction("Eagle_nebula"));
		backgrounds.add(new ChooseBackgroundAction("Custom..."));
		backgrounds.add(new ChooseBackgroundAction("Color..."));
	...
	private JMenu makeBackgroundMenu() {
		...
		menu.add(new ChooseBackgroundAction("Scotland"));
		menu.addSeparator();
    ...
    private class ChooseBackgroundAction extends AbstractAction {
    	...
    	ChooseBackgroundAction(String text) {
    		...
    		if (text.equals("Color...")) {
				putValue(Action.SHORT_DESCRIPTION, "Click here for color palette");
				BufferedImage colorIcon = new BufferedImage(32, 32, BufferedImage.TYPE_INT_RGB);
				Graphics new_icon = colorIcon.createGraphics();
				new_icon.setColor(Color.BLUE);
				new_icon.fillRect(0, 0, 32, 32);
				new_icon.setColor(Color.GREEN);
				new_icon.fillRect(4, 4, 28, 28);
				new_icon.dispose();
				...
				putValue(Action.SMALL_ICON,
				Util.iconFromResource("resources/action_icons/background.png"));
			} else
